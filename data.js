const POKEMON_DATA = {
  "pokemon": [
    { "name": "뮤츠", "nameEn": "Mewtwo", "category": "powerup", "fast": ["사이코커터", "염동력"], "charged": ["사이코브레이크", "섀도우볼"], "note": "섀도우 추천" },
    ...
    { "name": "맘모꾸리", "nameEn": "Mamoswine", "category": "powerup", "fast": ["가루눈","머드샷"], "charged": ["눈사태","지진"], "note": "얼음/땅 최강 어태커, 섀도우 추천" },
    { "name": "샹델라", "nameEn": "Chandelure", "category": "powerup", "fast": ["불꽃소용돌이","주술"], "charged": ["섀도우볼","오버히트"], "note": "고스트/불꽃 듀얼 어태커" },
    { "name": "다크라이", "nameEn": "Darkrai", "category": "powerup", "fast": ["으르렁","섀도우크루"], "charged": ["악의파동","섀도우볼"], "note": "악 최강 어태커" },
    ...
    { "name": "로즈레이드", "nameEn": "Roserade", "category": "powerup", "fast": ["독찌르기","풀베기"], "charged": ["풀묶기","독찔레꽂기"], "note": "풀/독 듀얼 어태커" },
    ...
    { "name": "이상해꽃", "nameEn": "Venusaur", "category": "powerup", "fast": ["덩굴채찍","풀베기"], "charged": ["하드플랜트","독찔레꽂기"], "note": "풀 어태커, 메가진화 가능, 섀도우 추천" },
    { "name": "리자몽", "nameEn": "Charizard", "category": "powerup", "fast": ["불꽃소용돌이","에어슬래시"], "charged": ["블라스트번","드래곤크루"], "note": "불꽃 어태커, 메가진화Y 추천" },
    { "name": "팬텀", "nameEn": "Gengar", "category": "powerup", "fast": ["섀도우크루","핥기"], "charged": ["섀도우볼","독찔레꽂기"], "note": "고스트 유리대포, 메가진화 가능" },
    { "name": "토게키스", "nameEn": "Togekiss", "category": "powerup", "fast": ["매지컬샤인","에어슬래시"], "charged": ["매지컬샤인","화염방사"], "note": "페어리 어태커" },
    { "name": "가디안", "nameEn": "Gardevoir", "category": "powerup", "fast": ["매지컬샤인","염동력"], "charged": ["매지컬샤인","사이코키네시스"], "note": "페어리 어태커, 메가진화 가능" },
    { "name": "자시안", "nameEn": "Zacian", "category": "powerup", "fast": ["속이기","메탈크루"], "charged": ["인파이트","와일드볼트"], "note": "마스터리그 탑티어, 페어리/강철" },
    ...
    { "name": "니드퀸", "nameEn": "Nidoqueen", "category": "ultra", "fast": ["독찌르기", "독침"], "charged": ["독찔레꽂기", "대지의힘"], "note": "섀도우 추천, 디버프 전략" },
    ...
    { "name": "탱그라", "nameEn": "Tangrowth", "category": "ultra", "fast": ["덩굴채찍", "풀묶기"], "charged": ["파워휩", "암석봉인"], "note": "XL 사탕 필요, 풀 탱커" },
    ...
    { "name": "해골몽", "nameEn": "Jellicent", "category": "ultra", "fast": ["헥스", "거품광선"], "charged": ["섀도우볼", "거품광선"], "note": "물/고스트, 탱커" },
    { "name": "드래피온", "nameEn": "Drapion", "category": "ultra", "fast": ["독찌르기", "물기"], "charged": ["깨물어부수기", "아쿠아테일"], "note": "독/악, 약점 적음" },
    { "name": "밤무아드", "nameEn": "Obstagoon", "category": "ultra", "fast": ["카운터", "혀로핥기"], "charged": ["야습", "크로스촙"], "note": "악/노말, 격투 이중약점 주의" },
    ...
    { "name": "엠페르트", "nameEn": "Empoleon", "category": "ultra", "fast": ["폭포", "메탈크루"], "charged": ["하이드로캐논", "드릴캐논"], "note": "커뮤데이 기술 필수, 물/강철" },
    { "name": "번치코", "nameEn": "Blaziken", "category": "ultra", "fast": ["카운터", "불꽃세례"], "charged": ["블라스트번", "브레이브버드"], "note": "커뮤데이 기술 필수, 불꽃/격투" },
    { "name": "날씬돌", "nameEn": "Gallade", "category": "ultra", "fast": ["염동력", "참격"], "charged": ["인파이트", "리프블레이드"], "note": "에스퍼/격투, 공격형" },
    { "name": "누오", "nameEn": "Quagsire", "category": "ultra", "fast": ["머드샷", "물대포"], "charged": ["스톤엣지", "지진"], "note": "XL 사탕 필요, 물/땅" },
    { "name": "다부니", "nameEn": "Greedent", "category": "ultra", "fast": ["머드샷", "박치기"], "charged": ["바디프레스", "깨물어부수기"], "note": "노말, XL 사탕 필요" },
    { "name": "하리뭉", "nameEn": "Hariyama", "category": "ultra", "fast": ["카운터", "발경"], "charged": ["인파이트", "헤비봄버"], "note": "격투 탱커" },
    { "name": "장크로다일", "nameEn": "Feraligatr", "category": "ultra", "fast": ["섀도우크루", "물대포"], "charged": ["하이드로캐논", "냉동펀치"], "note": "커뮤데이 기술 필수, 물" },
    ...
    { "name": "괴력몬(섀도우)", "nameEn": "Machamp (Shadow)", "category": "ultra", "fast": ["카운터", "발경"], "charged": ["크로스촙", "암석봉인"], "note": "섀도우, 격투 공격형" },
    { "name": "야부엉", "nameEn": "Noctowl", "category": "ultra", "fast": ["날개치기", "공기대포"], "charged": ["하늘깨기", "사이코키네시스"], "note": "XL 사탕 필요, 노말/비행 탱커" },
    ...
    { "name": "스와나", "nameEn": "Swanna", "category": "ultra", "fast": ["에어슬래시", "물대포"], "charged": ["아이싱하이드로", "허리케인"], "note": "물/비행, 접근성 좋음" },
    { "name": "너트령", "nameEn": "Ferrothorn", "category": "ultra", "fast": ["덩굴채찍", "메탈크루"], "charged": ["파워휩", "미러샷"], "note": "풀/강철 탱커" },
    { "name": "라티아스", "nameEn": "Latias", "category": "ultra", "fast": ["참격", "드래곤브레스"], "charged": ["역린", "사이코키네시스"], "note": "드래곤/에스퍼, 전설" },
    ...
    { "name": "겔가르", "nameEn": "Doublade", "category": "ultra", "fast": ["섀도우크루", "분노의앞니"], "charged": ["섀도우볼", "아이언헤드"], "note": "고스트/강철, 높은 방어" },

    // === 슈퍼리그 (Great League) S 티어 ===
    { "name": "마릴리", "nameEn": "Azumarill", "category": "super", "fast": ["물대포", "바위깨기"], "charged": ["얼음뭉치", "하이드로펌프"], "note": "슈퍼리그 탑티어, XL사탕 필요" },
    { "name": "레지스틸", "nameEn": "Registeel", "category": "super", "fast": ["록온", "메탈크루"], "charged": ["기합구슬", "래스터캐논"], "note": "탱커, 자핑캐논 추천" },
    { "name": "메디챔", "nameEn": "Medicham", "category": "super", "fast": ["카운터", "사이코커터"], "charged": ["냉동펀치", "사이코키네시스"], "note": "XL사탕 필요, 격투 탑" },
    { "name": "투구푸스", "nameEn": "Bastiodon", "category": "super", "fast": ["스매크다운", "아이언테일"], "charged": ["스톤엣지", "래스터캐논"], "note": "극탱커, XL사탕 필요" },
    { "name": "뚜벅초", "nameEn": "Trevenant", "category": "super", "fast": ["섀도우크루", "씨뿌리기"], "charged": ["씨폭탄", "섀도우볼"], "note": "풀/고스트 탑티어" },
    ...
    { "name": "독개굴", "nameEn": "Toxicroak", "category": "super", "fast": ["카운터", "독찌르기"], "charged": ["머드밤", "헤드스매시"], "note": "격투/독" },
    { "name": "리자몽(섀도우)", "nameEn": "Charizard (Shadow)", "category": "super", "fast": ["불꽃세례", "에어슬래시"], "charged": ["블라스트번", "드래곤크루"], "note": "섀도우, 커뮤데이 무브" },
    { "name": "무장조", "nameEn": "Heracross", "category": "super", "fast": ["카운터", "벌레먹기"], "charged": ["메가호른", "인파이트"], "note": "지역한정" },
    { "name": "독파리", "nameEn": "Tentacruel", "category": "super", "fast": ["독찌르기", "물대포"], "charged": ["독찔레꽂기", "애시드밤"], "note": "물/독 탱커" },
    { "name": "야도란(가라르)", "nameEn": "Slowbro (Galarian)", "category": "super", "fast": ["독찌르기", "혼란"], "charged": ["독찔레꽂기", "사이코키네시스"], "note": "가라르폼, 독/에스퍼" },
    ...
    { "name": "깜까미", "nameEn": "Sableye", "category": "super", "fast": ["섀도우크루", "훼이크아웃"], "charged": ["파울플레이", "리턴"], "note": "XL사탕 필요, 정화 추천" },
    ...
    { "name": "둥실라이드", "nameEn": "Drifblim", "category": "super", "fast": ["헥스", "바람일으키기"], "charged": ["아이시윈드", "섀도우볼"], "note": "고스트/비행" },
    { "name": "너트령", "nameEn": "Ferrothorn", "category": "super", "fast": ["덩굴채찍", "메탈크루"], "charged": ["파워휩", "미러샷"], "note": "풀/강철 탱커" },
    { "name": "멜시", "nameEn": "Carbink", "category": "super", "fast": ["바위깨기", "박치기"], "charged": ["스톤엣지", "문포스"], "note": "바위/페어리 탱커, XL사탕 필요" },
    ...
    { "name": "야부엉", "nameEn": "Noctowl", "category": "super", "fast": ["윙어택", "사이코커터"], "charged": ["하늘깨기", "섀도우볼"], "note": "노말/비행 탱커, XL사탕 필요" },
    { "name": "괴력몬(섀도우)", "nameEn": "Machamp (Shadow)", "category": "super", "fast": ["카운터", "발경"], "charged": ["크로스촙", "록블래스트"], "note": "섀도우 추천" },
    { "name": "나무킹", "nameEn": "Sceptile", "category": "super", "fast": ["덩굴채찍", "연속자르기"], "charged": ["리프블레이드", "지진"], "note": "풀 어태커" },
    { "name": "번치코", "nameEn": "Blaziken", "category": "super", "fast": ["카운터", "불꽃세례"], "charged": ["블라스트번", "브레이브버드"], "note": "격투/불꽃" },
    { "name": "내루미", "nameEn": "Lickitung", "category": "super", "fast": ["핥기", "젠헤드버트"], "charged": ["바디프레스", "파워휩"], "note": "XL사탕 필요, 극탱커" },
    { "name": "쥬레곤", "nameEn": "Dewgong", "category": "super", "fast": ["아이스샤드", "냉동바람"], "charged": ["아이시윈드", "물의파동"], "note": "레거시 무브 필요" },
    { "name": "독개굴(섀도우)", "nameEn": "Toxicroak (Shadow)", "category": "super", "fast": ["카운터", "독찌르기"], "charged": ["머드밤", "헤드스매시"], "note": "섀도우, 격투/독" },
    { "name": "폴리곤Z", "nameEn": "Porygon-Z", "category": "super", "fast": ["록온", "차지빔"], "charged": ["트라이어택", "냉동빔"], "note": "커뮤데이 무브 추천" },
    { "name": "라티아스", "nameEn": "Latias", "category": "super", "fast": ["참기", "드래곤브레스"], "charged": ["사이코키네시스", "역린"], "note": "전설, 드래곤/에스퍼" },
    { "name": "워시로토무", "nameEn": "Wash Rotom", "category": "super", "fast": ["선더쇼크", "바람일으키기"], "charged": ["하이드로펌프", "10만볼트"], "note": "전기/물" },
    { "name": "블래키", "nameEn": "Umbreon", "category": "super", "fast": ["울부짖기", "훼이크아웃"], "charged": ["파울플레이", "라스트리조트"], "note": "XL사탕 필요, 악 탱커" },
    { "name": "갸라도스(섀도우)", "nameEn": "Gyarados (Shadow)", "category": "super", "fast": ["드래곤브레스", "폭포"], "charged": ["아쿠아테일", "깨물어부수기"], "note": "섀도우, 물/비행" },
    { "name": "눈설왕(섀도우)", "nameEn": "Abomasnow (Shadow)", "category": "super", "fast": ["분말눈", "풀묶기"], "charged": ["웨더볼(얼음)", "에너지볼"], "note": "섀도우 추천, 풀/얼음" },
    ...
    { "name": "어데니", "nameEn": "Sizzlipede", "category": "dex", "fast": [], "charged": [], "note": "어데니 → 화데니" },
    { "name": "화데니", "nameEn": "Centiskorch", "category": "dex", "fast": [], "charged": [], "note": "불꽃/벌레" },
    ...
    { "name": "뜨아거", "nameEn": "Fuecoco", "category": "dex", "fast": [], "charged": [], "note": "뜨아거 → 악비아르 → 라우드본" },
    { "name": "악비아르", "nameEn": "Crocalor", "category": "dex", "fast": [], "charged": [], "note": "" },
    ...
    { "name": "아리뜰", "nameEn": "Fidough", "category": "dex", "fast": [], "charged": [], "note": "아리뜰 → 빠삐뜰리" },
    { "name": "빠삐뜰리", "nameEn": "Dachsbun", "category": "dex", "fast": [], "charged": [], "note": "페어리" },
