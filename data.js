const POKEMON_DATA = {
  "pokemon": [
    ...
    { "name": "라티아스", "nameEn": "Latias", "category": "powerup", "fast": ["드래곤브레스", "참격"], "charged": ["역린", "사이코키네시스"], "note": "메가진화 가능, 드래곤/에스퍼 전설" },
    ...
    { "name": "디안시", "nameEn": "Diancie", "category": "powerup", "fast": ["바위깨기", "박치기"], "charged": ["문포스", "스톤엣지"], "note": "메가진화 가능, 바위/페어리 환상 포켓몬" },
