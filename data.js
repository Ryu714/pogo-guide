const POKEMON_DATA = {
  "pokemon": [
    ...
    { "name": "찌리배리", "nameEn": "Bellibolt", "category": "ultra", "fast": ["전기쇼크"], "charged": ["패러볼릭차지", "방전"], "note": "#하1 하이퍼리그 탑티어, 패러볼릭차지 버프" },
    { "name": "레지스틸", "nameEn": "Registeel", "category": ["ultra", "super"], "fast": ["록온", "메탈크루"], "charged": ["기합구슬", "자핑캐논"], "note": "#하2 극탱커, 자핑캐논 추천" },
    { "name": "크레세리아", "nameEn": "Cresselia", "category": "ultra", "fast": ["신통력", "염동력"], "charged": ["문블라스트", "풀묶기"], "note": "#하3 탱커, 문블라스트 필수" },
    { "name": "아머까오", "nameEn": "Corviknight", "category": ["ultra", "super"], "fast": ["에어슬래시", "강철날개"], "charged": ["브레이브버드", "아이언헤드"], "note": "#하4 비행/강철, 하이퍼/슈퍼리그 S티어" },
    { "name": "라우드본", "nameEn": "Skeledirge", "category": ["ultra", "super"], "fast": ["소각"], "charged": ["토치송", "섀도우볼"], "note": "#하5 불꽃/고스트, 하이퍼/슈퍼리그 S티어" },
    { "name": "강챙이", "nameEn": "Poliwrath", "category": ["ultra", "super"], "fast": ["카운터", "머드샷"], "charged": ["열탕", "아이시윈드"], "note": "#하6 물/격투, 하이퍼리그 S티어, 슈퍼리그 A티어" },
    { "name": "코바르온", "nameEn": "Cobalion", "category": "ultra", "fast": ["더블킥", "메탈크루"], "charged": ["성스러운검", "스톤엣지"], "note": "#하7 강철/격투, 밸런스형" },
    { "name": "씨카이저", "nameEn": "Walrein", "category": "ultra", "fast": ["얼음엄니", "물대포"], "charged": ["고드름침", "지진"], "note": "#하8 커뮤데이 기술 필수" },
    { "name": "대로트", "nameEn": "Trevenant", "category": ["ultra", "super"], "fast": ["섀도우크루", "기습"], "charged": ["씨폭탄", "섀도우볼"], "note": "#하9 XL 사탕 필요, 풀/고스트" },
    { "name": "꼬이밍고", "nameEn": "Flamigo", "category": "ultra", "fast": ["더블킥", "윙어택"], "charged": ["어퍼핸드", "브레이브버드"], "note": "#하10 비행/격투, 하이퍼리그 S티어" },

    // ===== 하이퍼리그 (Ultra League) A 티어 =====
    { "name": "대짱이", "nameEn": "Swampert", "category": ["ultra", "super"], "fast": ["머드샷", "물대포"], "charged": ["하이드로캐논", "지진"], "note": "#하11 커뮤데이 기술 필수, 물/땅" },
    { "name": "블래키", "nameEn": "Umbreon", "category": ["ultra", "super"], "fast": ["으르렁", "속이기"], "charged": ["파울플레이", "라스트리조트"], "note": "#하12 XL 사탕 필요, 극탱커" },
    { "name": "저승갓숭", "nameEn": "Annihilape", "category": ["ultra", "super"], "fast": ["카운터", "섀도우크루"], "charged": ["섀도우볼", "인파이트"], "note": "#하13 격투/고스트, XL 사탕 필요" },
    { "name": "토오", "nameEn": "Clodsire", "category": ["ultra", "super"], "fast": ["독찌르기", "머드샷"], "charged": ["지진", "스톤엣지"], "note": "#하14 독/땅, 탱커" },
    { "name": "니드퀸", "nameEn": "Nidoqueen", "category": ["ultra", "super"], "fast": ["독찌르기", "물기"], "charged": ["독엄니", "대지의힘"], "note": "#하15 섀도우 추천, 디버프 전략" },
    { "name": "삼삼드래", "nameEn": "Hydreigon", "category": "ultra", "fast": ["물기", "드래곤브레스"], "charged": ["잔혹한일격", "용의파동"], "note": "#하16 악/드래곤, 하이퍼리그 A티어" },
    { "name": "플라제스", "nameEn": "Florges", "category": "ultra", "fast": ["참", "요정의바람"], "charged": ["매지컬샤인", "사이코키네시스"], "note": "#하17 페어리, 하이퍼리그 A티어" },
    { "name": "탱탱겔", "nameEn": "Jellicent", "category": "ultra", "fast": ["헥스", "거품"], "charged": ["섀도우볼", "거품광선"], "note": "#하18 물/고스트, 탱커" },
    { "name": "강철톤", "nameEn": "Steelix", "category": "ultra", "fast": ["드래곤테일", "아이언테일"], "charged": ["깨물어부수기", "지진"], "note": "#하19 XL 사탕 필요, 강철/땅 탱커" },
    { "name": "비리디온", "nameEn": "Virizion", "category": "ultra", "fast": ["더블킥"], "charged": ["리프블레이드", "성스러운검"], "note": "#하20 전설, 풀/격투, 엘리트TM 추천" },
    { "name": "레지드래고", "nameEn": "Regidrago", "category": "ultra", "fast": ["드래곤브레스"], "charged": ["드래곤에너지", "바이스그립"], "note": "#하21 드래곤, 전설, 엘리트TM 필요" },
    { "name": "독개굴", "nameEn": "Toxicroak", "category": ["ultra", "super"], "fast": ["카운터", "독찌르기"], "charged": ["머드봄", "오물웨이브"], "note": "#하22 격투/독, 쉴드 압박" },
    { "name": "무장조", "nameEn": "Skarmory", "category": ["ultra", "super"], "fast": ["에어슬래시", "강철날개"], "charged": ["브레이브버드", "하늘깨기"], "note": "#하23 강철/비행 탱커, 하이퍼리그 XL 사탕 필요" },
    { "name": "라프라스", "nameEn": "Lapras", "category": ["ultra", "super"], "fast": ["아이스샤드", "물대포"], "charged": ["서핑", "냉동빔"], "note": "#하24 얼음/물 탱커" },
    { "name": "드래피온", "nameEn": "Drapion", "category": "ultra", "fast": ["독찌르기", "물기"], "charged": ["깨물어부수기", "아쿠아테일"], "note": "#하25 독/악, 약점 적음" },

    // ===== 하이퍼리그 (Ultra League) B 티어 =====
    { "name": "덩쿠림보", "nameEn": "Tangrowth", "category": "ultra", "fast": ["덩굴채찍", "벌레침입"], "charged": ["파워휩", "암석봉인"], "note": "#하26 XL 사탕 필요, 풀 탱커" },
    { "name": "가로막구리", "nameEn": "Obstagoon", "category": "ultra", "fast": ["카운터", "핥기"], "charged": ["야습", "크로스촙"], "note": "#하27 악/노말, 격투 이중약점 주의" },
    { "name": "눈여아", "nameEn": "Froslass", "category": "ultra", "fast": ["눈싸라기", "헥스"], "charged": ["눈사태", "섀도우볼"], "note": "#하28 얼음/고스트, 쉴드 압박" },
    { "name": "파비코리", "nameEn": "Altaria", "category": "ultra", "fast": ["드래곤브레스", "짓찧기"], "charged": ["문포스", "하늘깨기"], "note": "#하29 XL 사탕 필요, 드래곤/비행" },
    { "name": "야도란(가라르)", "nameEn": "Slowbro (Galarian)", "category": ["ultra", "super"], "fast": ["독찌르기", "염동력"], "charged": ["기합구슬", "오물웨이브"], "note": "#하30 가라르폼, 독/에스퍼" },
    { "name": "엠페르트", "nameEn": "Empoleon", "category": "ultra", "fast": ["폭포", "메탈크루"], "charged": ["하이드로캐논", "드릴쪼기"], "note": "#하31 커뮤데이 기술 필수, 물/강철" },
    { "name": "번치코", "nameEn": "Blaziken", "category": ["ultra", "super"], "fast": ["카운터", "불꽃소용돌이"], "charged": ["블라스트번", "브레이브버드"], "note": "#하32 커뮤데이 기술 필수, 불꽃/격투" },
    { "name": "너트령", "nameEn": "Ferrothorn", "category": ["ultra", "super"], "fast": ["덩굴채찍", "메탈크루"], "charged": ["파워휩", "미러샷"], "note": "#하33 풀/강철 탱커" },
    { "name": "바리톱스", "nameEn": "Bastiodon", "category": ["ultra", "super"], "fast": ["스매크다운", "아이언테일"], "charged": ["스톤엣지", "래스터캐논"], "note": "#하34 XL 사탕 필요, 극탱커" },
    { "name": "전지충이", "nameEn": "Charjabug", "category": ["ultra", "super"], "fast": ["스파크", "벌레먹기"], "charged": ["방전", "엑스시저"], "note": "#하35 벌레/전기 탱커, XL 사탕 필요" },
    { "name": "야부엉", "nameEn": "Noctowl", "category": ["ultra", "super"], "fast": ["날개치기", "신통력"], "charged": ["하늘깨기", "사이코키네시스"], "note": "#하36 XL 사탕 필요, 노말/비행 탱커" },
    { "name": "장크로다일", "nameEn": "Feraligatr", "category": "ultra", "fast": ["물대포", "얼음엄니"], "charged": ["하이드로캐논", "냉동빔"], "note": "#하37 커뮤데이 기술 필수, 물" },
    { "name": "괴력몬(섀도우)", "nameEn": "Machamp (Shadow)", "category": ["ultra", "super"], "fast": ["카운터", "불릿펀치"], "charged": ["크로스촙", "록슬라이드"], "note": "#하38 섀도우 격투 공격형" },
    { "name": "엘레이드", "nameEn": "Gallade", "category": "ultra", "fast": ["염동력", "로킥"], "charged": ["인파이트", "리프블레이드"], "note": "#하39 에스퍼/격투, 공격형" },
    { "name": "누오", "nameEn": "Quagsire", "category": "ultra", "fast": ["머드샷", "물대포"], "charged": ["스톤엣지", "지진"], "note": "#하40 XL 사탕 필요, 물/땅" },
    { "name": "미끄래곤", "nameEn": "Goodra", "category": "ultra", "fast": ["드래곤브레스", "물대포"], "charged": ["파워휩", "머디워터"], "note": "#하41 드래곤, 다양한 기술배치" },
    { "name": "폴리곤Z", "nameEn": "Porygon-Z", "category": ["ultra", "super"], "fast": ["록온", "차지빔"], "charged": ["트라이어택", "섀도우볼"], "note": "#하42 노말, 커뮤데이 기술 추천" },
    { "name": "샤로다", "nameEn": "Serperior", "category": "ultra", "fast": ["덩굴채찍", "아이언테일"], "charged": ["하드플랜트", "공중날기"], "note": "#하43 커뮤데이 기술 필수, 풀" },
    { "name": "토대부기", "nameEn": "Torterra", "category": "ultra", "fast": ["면도날잎", "물기"], "charged": ["하드플랜트", "스톤엣지"], "note": "#하44 커뮤데이 기술 필수, 풀/땅" },
    { "name": "눈설왕", "nameEn": "Abomasnow", "category": "ultra", "fast": ["눈싸라기", "면도날잎"], "charged": ["날씨볼", "에너지볼"], "note": "#하45 풀/얼음, 빠른 차지무브" },
    { "name": "슈바르고", "nameEn": "Escavalier", "category": "ultra", "fast": ["카운터", "벌레먹기"], "charged": ["메가호른", "드릴쪼기"], "note": "#하46 벌레/강철" },
    { "name": "야도킹(가라르)", "nameEn": "Slowking (Galarian)", "category": "ultra", "fast": ["독찌르기", "염동력"], "charged": ["오물웨이브", "섀도우볼"], "note": "#하47 가라르폼, 독/에스퍼" },
    { "name": "마기라스(섀도우)", "nameEn": "Tyranitar (Shadow)", "category": "ultra", "fast": ["물기", "스매크다운"], "charged": ["깨물어부수기", "스톤엣지"], "note": "#하48 섀도우, 악/바위" },
    { "name": "플라이곤", "nameEn": "Flygon", "category": "ultra", "fast": ["머드샷", "드래곤테일"], "charged": ["드래곤크루", "대지의힘"], "note": "#하49 땅/드래곤, 접근성 좋음" },
    { "name": "하리뭉", "nameEn": "Hariyama", "category": "ultra", "fast": ["카운터", "불릿펀치"], "charged": ["인파이트", "헤비봄버"], "note": "#하50 격투 탱커" },
    { "name": "스완나", "nameEn": "Swanna", "category": "ultra", "fast": ["에어슬래시", "물대포"], "charged": ["냉동빔", "허리케인"], "note": "#하51 물/비행, 접근성 좋음" },
    { "name": "요씽리스", "nameEn": "Greedent", "category": "ultra", "fast": ["불릿시드", "몸통박치기"], "charged": ["바디슬램", "깨물어부수기"], "note": "#하52 노말, XL 사탕 필요" },
    { "name": "해피너스", "nameEn": "Blissey", "category": "ultra", "fast": ["짓찧기", "선취"], "charged": ["사이코키네시스", "매지컬샤인"], "note": "#하53 체육관 방어 전용, 극탱커" },
    { "name": "쌍검킬", "nameEn": "Doublade", "category": "dex", "fast": [], "charged": [], "note": "외뿔검 → 쌍검킬 → 킹검 (고스트/강철)" },

    // ===== 슈퍼리그 (Great League) S 티어 =====
    { "name": "마릴리", "nameEn": "Azumarill", "category": "super", "fast": ["거품", "바위깨기"], "charged": ["냉동빔", "하이드로펌프"], "note": "#슈1 슈퍼리그 탑티어, XL사탕 필요" },
    { "name": "멜리시", "nameEn": "Carbink", "category": "super", "fast": ["바위던지기", "돌진"], "charged": ["록슬라이드", "문블라스트"], "note": "#슈2 바위/페어리 탱커, XL사탕 필요" },
    // 레지스틸은 하이퍼리그 섹션에 #하2로 등록됨 (["ultra", "super"])
    { "name": "요가램", "nameEn": "Medicham", "category": "super", "fast": ["카운터", "신통력"], "charged": ["냉동펀치", "사이코키네시스"], "note": "#슈4 XL사탕 필요, 격투 탑" },
    // 아머까오는 하이퍼리그 섹션에 #하4로 등록됨 (["ultra", "super"])
    // 라우드본은 하이퍼리그 섹션에 #하5로 등록됨 (["ultra", "super"])
    // 저승갓숭은 하이퍼리그 섹션에 #하13으로 등록됨 (["ultra", "super"])
    { "name": "다꼬리", "nameEn": "Furret", "category": "super", "fast": ["속이기"], "charged": ["스위프트", "트레일블레이즈"], "note": "#슈8 2025 버프, 슈퍼리그 탑티어" },
    { "name": "푸크린", "nameEn": "Wigglytuff", "category": "super", "fast": ["참"], "charged": ["아이시윈드", "디사밍보이스"], "note": "#슈9 노말/페어리, 슈퍼리그 S티어" },
    { "name": "깜까미", "nameEn": "Sableye", "category": "super", "fast": ["섀도우크루", "속이기"], "charged": ["파울플레이", "리턴"], "note": "#슈10 XL사탕 필요, 정화 추천" },

    // ===== 슈퍼리그 (Great League) A 티어 =====
    // 바리톱스는 하이퍼리그 섹션에 #하34로 등록됨 (["ultra", "super"])
    // 대로트는 하이퍼리그 섹션에 #하9로 등록됨 (["ultra", "super"])
    // 니드퀸은 하이퍼리그 섹션에 #하15로 등록됨 (["ultra", "super"])
    // 대짱이는 하이퍼리그 섹션에 #하11로 등록됨 (["ultra", "super"])
    // 블래키는 하이퍼리그 섹션에 #하12로 등록됨 (["ultra", "super"])
    // 토오는 하이퍼리그 섹션에 #하14로 등록됨 (["ultra", "super"])
    // 무장조는 하이퍼리그 섹션에 #하23으로 등록됨 (["ultra", "super"])
    { "name": "내루미", "nameEn": "Lickitung", "category": "super", "fast": ["핥기", "선취"], "charged": ["바디슬램", "파워휩"], "note": "#슈18 XL사탕 필요, 극탱커" },
    // 강챙이는 하이퍼리그 섹션에 #하6으로 등록됨 (["ultra", "super"])
    // 독개굴은 하이퍼리그 섹션에 #하22로 등록됨 (["ultra", "super"])
    // 너트령은 하이퍼리그 섹션에 #하33으로 등록됨 (["ultra", "super"])
    { "name": "릴리요", "nameEn": "Cradily", "category": "super", "fast": ["불릿시드", "산성"], "charged": ["록툼", "그래스노트"], "note": "#슈22 바위/풀, 2025 록툼 버프로 슈퍼리그 주요 픽" },
    { "name": "데덴네", "nameEn": "Dedenne", "category": "super", "fast": ["전기쇼크"], "charged": ["방전", "플레이라프"], "note": "#슈23 전기/페어리, 슈퍼리그 A티어" },
    // 라프라스는 하이퍼리그 섹션에 #하24로 등록됨 (["ultra", "super"])
    // 야부엉은 하이퍼리그 섹션에 #하36으로 등록됨 (["ultra", "super"])

    // ===== 슈퍼리그 (Great League) B 티어 =====
    // 전지충이는 하이퍼리그 섹션에 #하35로 등록됨 (["ultra", "super"])
    // 번치코는 하이퍼리그 섹션에 #하32로 등록됨 (["ultra", "super"])
    // 야도란(가라르)은 하이퍼리그 섹션에 #하30으로 등록됨 (["ultra", "super"])
    // 괴력몬(섀도우)은 하이퍼리그 섹션에 #하38로 등록됨 (["ultra", "super"])
    { "name": "날쌩마(가라르)", "nameEn": "Rapidash (Galarian)", "category": "super", "fast": ["요정의바람", "신통력"], "charged": ["바디슬램", "메가호른"], "note": "#슈30 가라르폼, 페어리" },
    { "name": "라이츄(알로라)", "nameEn": "Raichu (Alolan)", "category": "super", "fast": ["볼트체인지", "스파크"], "charged": ["와일드볼트", "사이코키네시스"], "note": "#슈31 알로라폼" },
    { "name": "패리퍼", "nameEn": "Pelipper", "category": "super", "fast": ["윙어택", "물대포"], "charged": ["웨더볼(물)", "허리케인"], "note": "#슈32 물/비행" },
    { "name": "리자몽(섀도우)", "nameEn": "Charizard (Shadow)", "category": "super", "fast": ["불꽃소용돌이", "에어슬래시"], "charged": ["블라스트번", "드래곤크루"], "note": "#슈33 섀도우, 커뮤데이 무브" },
    { "name": "독파리", "nameEn": "Tentacruel", "category": "super", "fast": ["독찌르기", "물대포"], "charged": ["독엄니", "애시드밤"], "note": "#슈34 물/독 탱커" },
    ...
    { "name": "대코파스", "nameEn": "Probopass", "category": "super", "fast": ["스파크", "바위던지기"], "charged": ["매그넷봄", "록슬라이드"], "note": "#슈35 바위/강철 탱커" },
    { "name": "붐볼(히스이)", "nameEn": "Electrode (Hisuian)", "category": "super", "fast": ["볼트체인지", "선더쇼크"], "charged": ["에너지볼", "와일드볼트"], "note": "#슈36 히스이폼, 전기/풀" },
    { "name": "프리져(가라르)", "nameEn": "Articuno (Galarian)", "category": "super", "fast": ["신통력", "혼란"], "charged": ["미래예지", "고대의힘"], "note": "#슈37 가라르폼, 전설" },
    // 폴리곤Z는 하이퍼리그 섹션에 #하42로 등록됨 (["ultra", "super"])
    { "name": "뮤", "nameEn": "Mew", "category": "super", "fast": ["섀도우크루", "볼트체인지"], "charged": ["서핑", "와일드볼트"], "note": "#슈39 다양한 기술셋 가능" },
    { "name": "둥실라이드", "nameEn": "Drifblim", "category": "super", "fast": ["헥스", "놀래키기"], "charged": ["아이시윈드", "섀도우볼"], "note": "#슈40 고스트/비행" },
    { "name": "메깅", "nameEn": "Whiscash", "category": "super", "fast": ["머드샷", "물대포"], "charged": ["머드밤", "냉동빔"], "note": "#슈41 물/땅 저코스트" },
    { "name": "대짱이(섀도우)", "nameEn": "Swampert (Shadow)", "category": "super", "fast": ["머드샷", "물대포"], "charged": ["하이드로캐논", "지진"], "note": "#슈42 섀도우, 커뮤데이 무브 필수" },
    { "name": "나무킹", "nameEn": "Sceptile", "category": "super", "fast": ["덩굴채찍", "연속자르기"], "charged": ["리프블레이드", "지진"], "note": "#슈43 풀 어태커" },
    { "name": "쥬레곤", "nameEn": "Dewgong", "category": "super", "fast": ["아이스샤드", "서리숨결"], "charged": ["아이시윈드", "물의파동"], "note": "#슈44 레거시 무브 필요" },
    { "name": "독개굴(섀도우)", "nameEn": "Toxicroak (Shadow)", "category": "super", "fast": ["카운터", "독찌르기"], "charged": ["머드밤", "폭발펀치"], "note": "#슈45 섀도우, 격투/독" },
    { "name": "워시로토무", "nameEn": "Wash Rotom", "category": "super", "fast": ["선더쇼크", "놀래키기"], "charged": ["하이드로펌프", "10만볼트"], "note": "#슈46 전기/물" },
    { "name": "갸라도스(섀도우)", "nameEn": "Gyarados (Shadow)", "category": "super", "fast": ["드래곤브레스", "폭포"], "charged": ["아쿠아테일", "깨물어부수기"], "note": "#슈47 섀도우, 물/비행" },
    { "name": "눈설왕(섀도우)", "nameEn": "Abomasnow (Shadow)", "category": "super", "fast": ["가루눈", "면도날잎"], "charged": ["웨더볼(얼음)", "에너지볼"], "note": "#슈48 섀도우 추천, 풀/얼음" },
    { "name": "어흥염", "nameEn": "Incineroar", "category": "super", "fast": ["불꽃소용돌이", "으르렁"], "charged": ["블라스트번", "다크래리어트"], "note": "#슈49 불꽃/악" },
    { "name": "마임꽁꽁", "nameEn": "Mr. Rime", "category": "super", "fast": ["아이스샤드", "혼란"], "charged": ["아이시윈드", "사이코키네시스"], "note": "#슈50 얼음/에스퍼, 가라르 마임맨 진화" },
    ...
    { "name": "보송송", "nameEn": "Flaaffy", "category": "dex", "fast": [], "charged": [], "note": "메리프 → 보우양 → 전룡" },
    ...
    { "name": "모부기", "nameEn": "Turtwig", "category": "dex", "fast": [], "charged": [], "note": "모부기 → 수풀부기 → 토대부기" },
    { "name": "수풀부기", "nameEn": "Grotle", "category": "dex", "fast": [], "charged": [], "note": "모부기 → 수풀부기 → 토대부기" },
    ...
    { "name": "두개도스", "nameEn": "Cranidos", "category": "dex", "fast": [], "charged": [], "note": "두루미 → 램펄드 (희귀 화석)" },
    ...
    { "name": "흔들풍손", "nameEn": "Drifloon", "category": "dex", "fast": [], "charged": [], "note": "흔들풍손 → 둥실라이드" },
    ...
    // --- 대포무노 ---
    { "name": "돈크로우", "nameEn": "Honchkrow", "category": "dex", "fast": [], "charged": [], "note": "니로우 → 대포무노 (어둠의돌)" },
    ...
    { "name": "스콜피", "nameEn": "Skorupi", "category": "dex", "fast": [], "charged": [], "note": "스콜피 → 드래피온" },

    // --- 삐딱충이 (독개굴은 competitive) ---
    { "name": "삐딱구리", "nameEn": "Croagunk", "category": "dex", "fast": [], "charged": [], "note": "삐딱구리 → 독개굴" },
    ...
    // --- 마네네 (베이비) ---
    { "name": "꼬지지", "nameEn": "Bonsly", "category": "dex", "fast": [], "charged": [], "note": "꼬지지 → 꼬지모 (베이비)" },

    // --- 흔들란 (베이비) ---
    { "name": "랑딸랑", "nameEn": "Chingling", "category": "dex", "fast": [], "charged": [], "note": "랑딸랑 → 치렁 (베이비)" },
    ...
    // --- 얼루기 라인 ---
    { "name": "줄뮤마", "nameEn": "Blitzle", "category": "dex", "fast": [], "charged": [], "note": "줄뮤마 → 제브라이카" },
    { "name": "제브라이카", "nameEn": "Zebstrika", "category": "dex", "fast": [], "charged": [], "note": "줄뮤마 → 제브라이카, 전기" },

    // --- 단굴 (몰드류/두더류는 competitive) ---
    { "name": "두더류", "nameEn": "Drilbur", "category": "dex", "fast": [], "charged": [], "note": "두더류 → 몰드류" },

    // --- 다부니 ---
    { "name": "다부니", "nameEn": "Audino", "category": "dex", "fast": [], "charged": [], "note": "진화 없음, 메가 진화 가능, 희귀" },

    // --- 짐보리 라인 (노보청은 competitive) ---
    { "name": "으랏차", "nameEn": "Timburr", "category": "dex", "fast": [], "charged": [], "note": "으랏차 → 토쇠골 → 노보청" },
    { "name": "토쇠골", "nameEn": "Gurdurr", "category": "dex", "fast": [], "charged": [], "note": "으랏차 → 토쇠골 → 노보청" },

    // --- 두까비 라인 ---
    { "name": "동챙이", "nameEn": "Tympole", "category": "dex", "fast": [], "charged": [], "note": "동챙이 → 두까비 → 두빅굴" },
    { "name": "두까비", "nameEn": "Palpitoad", "category": "dex", "fast": [], "charged": [], "note": "동챙이 → 두까비 → 두빅굴" },
    ...
    // --- 치릴리 라인 ---
    { "name": "소미안", "nameEn": "Cottonee", "category": "dex", "fast": [], "charged": [], "note": "소미안 → 엘풍 (태양의돌)" },
    { "name": "엘풍", "nameEn": "Whimsicott", "category": "dex", "fast": [], "charged": [], "note": "풀/페어리" },

    // --- 쁘사이저 라인 ---
    { "name": "치릴리", "nameEn": "Petilil", "category": "dex", "fast": [], "charged": [], "note": "치릴리 → 드레디아 (태양의돌)" },
    { "name": "드레디어", "nameEn": "Lilligant", "category": "dex", "fast": [], "charged": [], "note": "치릴리 → 드레디아, 풀" },

    // --- 바스라오 ---
    { "name": "배쓰나이", "nameEn": "Basculin", "category": "trash", "fast": [], "charged": [], "note": "적색/청색 줄무늬" },

    // --- 깜까미 라인 ---
    { "name": "깜눈크", "nameEn": "Sandile", "category": "dex", "fast": [], "charged": [], "note": "깜눈크 → 악비르 → 악비아르" },
    { "name": "악비르", "nameEn": "Krokorok", "category": "dex", "fast": [], "charged": [], "note": "깜눈크 → 악비르 → 악비아르" },
    { "name": "악비아르", "nameEn": "Krookodile", "category": "dex", "fast": [], "charged": [], "note": "땅/악" },

    // --- 달막화 라인 ---
    { "name": "달막화", "nameEn": "Darumaka", "category": "dex", "fast": [], "charged": [], "note": "달막화 → 불비달마" },
    { "name": "불비달마", "nameEn": "Darmanitan", "category": "dex", "fast": [], "charged": [], "note": "달막화 → 불비달마, 불꽃" },
    ...
    { "name": "곤율랭", "nameEn": "Scraggy", "category": "dex", "fast": [], "charged": [], "note": "곤율랭 → 곤율거니" },
    ...
    // --- 독오리 라인 ---
    { "name": "꼬지보리", "nameEn": "Ducklett", "category": "dex", "fast": [], "charged": [], "note": "꼬지보리 → 스와나" },
    ...
    { "name": "탱그릴", "nameEn": "Frillish", "category": "dex", "fast": [], "charged": [], "note": "탱그릴 → 해골몽 (암수 다름)" },

    // --- 알로마담 ---
    { "name": "맘복치", "nameEn": "Alomomola", "category": "dex", "fast": [], "charged": [], "note": "진화 없음, 희귀, 물" },

    // --- 전기거미 라인 ---
    { "name": "파쪼옥", "nameEn": "Joltik", "category": "dex", "fast": [], "charged": [], "note": "파쪼옥 → 전툴라" },
    ...
    { "name": "불켜미", "nameEn": "Litwick", "category": "dex", "fast": [], "charged": [], "note": "불켜미 → 램프라 → 샹델라" },
    { "name": "램프라", "nameEn": "Lampent", "category": "dex", "fast": [], "charged": [], "note": "불켜미 → 램프라 → 샹델라" },

    // --- 터비 라인 (도끼라크는 competitive) ---
    { "name": "터검니", "nameEn": "Axew", "category": "dex", "fast": [], "charged": [], "note": "터검니 → 액슨도 → 액스라이즈 (희귀)" },
    { "name": "액슨도", "nameEn": "Fraxure", "category": "dex", "fast": [], "charged": [], "note": "터검니 → 액슨도 → 액스라이즈" },
    ...
    // --- 쉘더 라인 ---
    { "name": "쪼마리", "nameEn": "Shelmet", "category": "dex", "fast": [], "charged": [], "note": "쪼마리 → 어지리더 (교환 진화)" },
    ...
    // --- 미트민 라인 ---
    { "name": "비조푸", "nameEn": "Mienfoo", "category": "dex", "fast": [], "charged": [], "note": "비조푸 → 비조도" },
    { "name": "비조도", "nameEn": "Mienshao", "category": "dex", "fast": [], "charged": [], "note": "격투" },

    // --- 체스피 라인 ---
    { "name": "자망칼", "nameEn": "Pawniard", "category": "dex", "fast": [], "charged": [], "note": "자망칼 → 절각참" },
    ...
    // --- 바르비트 라인 ---
    { "name": "수리둥보", "nameEn": "Rufflet", "category": "dex", "fast": [], "charged": [], "note": "수리둥보 → 워글" },
    { "name": "워글", "nameEn": "Braviary", "category": "dex", "fast": [], "charged": [], "note": "노말/비행" },

    // --- 바르차이 (버랜지나는 competitive) ---
    { "name": "벌차이", "nameEn": "Vullaby", "category": "dex", "fast": [], "charged": [], "note": "벌차이 → 버랜지나" },
    ...
    // --- 골릿 (골루그는 competitive) ---
    { "name": "골비람", "nameEn": "Golett", "category": "dex", "fast": [], "charged": [], "note": "골릿 → 골루그" },
    ...
    // --- 나룸 라인 ---
    { "name": "나룸퍼프", "nameEn": "Swirlix", "category": "dex", "fast": [], "charged": [], "note": "나룸퍼프 → 나루림" },
    ...
    // --- 개미신 라인 ---
    { "name": "거북손손", "nameEn": "Binacle", "category": "dex", "fast": [], "charged": [], "note": "거북손손 → 거북손데스" },
    { "name": "거북손데스", "nameEn": "Barbaracle", "category": "dex", "fast": [], "charged": [], "note": "바위/물" },

    // --- 드라미도로 라인 ---
    { "name": "수레기", "nameEn": "Skrelp", "category": "dex", "fast": [], "charged": [], "note": "수레기 → 드래캄" },
    { "name": "드래캄", "nameEn": "Dragalge", "category": "dex", "fast": [], "charged": [], "note": "독/드래곤" },

    // --- 수레기 라인 ---
    { "name": "완철포", "nameEn": "Clauncher", "category": "dex", "fast": [], "charged": [], "note": "완철포 → 블로스터" },
    { "name": "블로스터", "nameEn": "Clawitzer", "category": "dex", "fast": [], "charged": [], "note": "물" },

    // --- 목도리키드 라인 ---
    { "name": "목도리키텔", "nameEn": "Helioptile", "category": "dex", "fast": [], "charged": [], "note": "목도리키텔 → 일레도리자드" },
    { "name": "일레도리자드", "nameEn": "Heliolisk", "category": "dex", "fast": [], "charged": [], "note": "전기/노말" },

    // --- 치고라스 라인 ---
    { "name": "티고라스", "nameEn": "Tyrunt", "category": "dex", "fast": [], "charged": [], "note": "티고라스 → 견고라스 (희귀 화석)" },
    ...
    // --- 데디캥 (데덴네는 슈퍼리그 섹션으로 이동) ---

    // --- 멜시 (이미 competitive) ---

    // --- 미끄네일 라인 (미끄래곤은 competitive) ---
    { "name": "미끄메라", "nameEn": "Goomy", "category": "dex", "fast": [], "charged": [], "note": "미끄메라 → 미끄네뇽 → 미끄래곤 (희귀)" },
    ...
    { "name": "나목령", "nameEn": "Phantump", "category": "dex", "fast": [], "charged": [], "note": "나목령 → 오롯트 (교환 진화)" },
    ...
    // ===== 7세대 (알로라) Dex / Trash =====
    // --- 스타팅/진화 체인 ---
    { "name": "나몰빼미", "nameEn": "Rowlet", "category": "dex", "fast": [], "charged": [], "note": "나몰빼미 → 빼미스로우 → 모크나이퍼" },
    { "name": "빼미스로우", "nameEn": "Dartrix", "category": "dex", "fast": [], "charged": [], "note": "나몰빼미 → 빼미스로우 → 모크나이퍼 (풀/비행)" },
    { "name": "모크나이퍼", "nameEn": "Decidueye", "category": "dex", "fast": [], "charged": [], "note": "나몰빼미 최종 진화 (풀/고스트)" },
    { "name": "냐오불", "nameEn": "Litten", "category": "dex", "fast": [], "charged": [], "note": "냐오불 → 냐오히트 → 어흥염" },
    { "name": "냐오히트", "nameEn": "Torracat", "category": "dex", "fast": [], "charged": [], "note": "냐오불 → 냐오히트 → 어흥염 (불꽃)" },
    ...
    { "name": "턱지충이", "nameEn": "Grubbin", "category": "dex", "fast": [], "charged": [], "note": "턱지충이 → 전지충이 → 차머드" },
    { "name": "투구뿌논", "nameEn": "Vikavolt", "category": "dex", "fast": [], "charged": [], "note": "전지충이 최종 진화 (벌레/전기)" },
    ...
    { "name": "오기지게", "nameEn": "Crabrawler", "category": "dex", "fast": [], "charged": [], "note": "망키 → 맨쿠마" },
    ...
    // --- 일반 7세대 ---
    { "name": "암멍이", "nameEn": "Rockruff", "category": "dex", "fast": [], "charged": [], "note": "이와룡 → 루가루간 (낮/밤/황혼 폼)" },
    { "name": "루가루암", "nameEn": "Lycanroc", "category": "dex", "fast": [], "charged": [], "note": "3가지 폼 (낮/밤/황혼)" },
    { "name": "에블리", "nameEn": "Cutiefly", "category": "dex", "fast": [], "charged": [], "note": "큐아르거 → 에블리" },
    { "name": "에리본", "nameEn": "Ribombee", "category": "dex", "fast": [], "charged": [], "note": "벌레/페어리" },
    { "name": "약어리", "nameEn": "Wishiwashi", "category": "trash", "fast": [], "charged": [], "note": "물" },
    { "name": "시마사리", "nameEn": "Mareanie", "category": "dex", "fast": [], "charged": [], "note": "해무기 → 독해파리" },
    { "name": "더시마사리", "nameEn": "Toxapex", "category": "dex", "fast": [], "charged": [], "note": "독/물, 높은 방어" },
    { "name": "머드나기", "nameEn": "Mudbray", "category": "dex", "fast": [], "charged": [], "note": "누리사치 → 만마드" },
    { "name": "만마드", "nameEn": "Mudsdale", "category": "dex", "fast": [], "charged": [], "note": "땅" },
    { "name": "물거미", "nameEn": "Dewpider", "category": "dex", "fast": [], "charged": [], "note": "빛나오라 → 깨비무소" },
    { "name": "깨비물거미", "nameEn": "Araquanid", "category": "dex", "fast": [], "charged": [], "note": "물/벌레, PvP 활용" },
    { "name": "짜랑랑", "nameEn": "Fomantis", "category": "dex", "fast": [], "charged": [], "note": "대라비 → 라란티스" },
    { "name": "라란티스", "nameEn": "Lurantis", "category": "dex", "fast": [], "charged": [], "note": "풀" },
    { "name": "야도뇽", "nameEn": "Salandit", "category": "dex", "fast": [], "charged": [], "note": "가재장군♀ → 염뉴트 (암컷만 진화)" },
    { "name": "염뉴트", "nameEn": "Salazzle", "category": "dex", "fast": [], "charged": [], "note": "독/불꽃, 암컷만 진화 가능" },
    { "name": "포곰곰", "nameEn": "Stufful", "category": "dex", "fast": [], "charged": [], "note": "단단지 → 이름곰" },
    { "name": "이븐곰", "nameEn": "Bewear", "category": "dex", "fast": [], "charged": [], "note": "노말/격투" },
    { "name": "달콤아", "nameEn": "Bounsweet", "category": "dex", "fast": [], "charged": [], "note": "꾸몬 → 달무리나 → 달콤나" },
    { "name": "달무리나", "nameEn": "Steenee", "category": "dex", "fast": [], "charged": [], "note": "" },
    { "name": "달코퀸", "nameEn": "Tsareena", "category": "dex", "fast": [], "charged": [], "note": "풀" },
    { "name": "큐아링", "nameEn": "Comfey", "category": "dex", "fast": [], "charged": [], "note": "페어리, 하와이 지역한정" },
    { "name": "하랑우탄", "nameEn": "Oranguru", "category": "trash", "fast": [], "charged": [], "note": "노말/에스퍼" },
    { "name": "내던숭이", "nameEn": "Passimian", "category": "trash", "fast": [], "charged": [], "note": "격투" },
    { "name": "모래꿍", "nameEn": "Sandygast", "category": "dex", "fast": [], "charged": [], "note": "사니곤 → 사니캐슬" },
    { "name": "모래성이당", "nameEn": "Palossand", "category": "dex", "fast": [], "charged": [], "note": "고스트/땅" },
    { "name": "춤추새", "nameEn": "Oricorio", "category": "dex", "fast": [], "charged": [], "note": "4가지 스타일 (꽃넥타)" },
    { "name": "해무기", "nameEn": "Pyukumuku", "category": "trash", "fast": [], "charged": [], "note": "물" },
    { "name": "자마슈", "nameEn": "Morelull", "category": "dex", "fast": [], "charged": [], "note": "흉몽이 → 빛둥이" },
    { "name": "마셰이드", "nameEn": "Shiinotic", "category": "dex", "fast": [], "charged": [], "note": "풀/페어리" },
    { "name": "메테노", "nameEn": "Minior", "category": "dex", "fast": [], "charged": [], "note": "바위/비행, 다양한 색상" },
    { "name": "꼬시레", "nameEn": "Wimpod", "category": "dex", "fast": [], "charged": [], "note": "도롱충이 → 위첨보" },
    { "name": "갑주무사", "nameEn": "Golisopod", "category": "dex", "fast": [], "charged": [], "note": "벌레/물" },
    { "name": "짜랑꼬", "nameEn": "Jangmo-o", "category": "dex", "fast": [], "charged": [], "note": "넥스몬 → 쟈랑고 → 쟈란고" },
    { "name": "짜랑고우", "nameEn": "Hakamo-o", "category": "dex", "fast": [], "charged": [], "note": "" },
    { "name": "짜랑고우거", "nameEn": "Kommo-o", "category": "dex", "fast": [], "charged": [], "note": "드래곤/격투, 600족" },
    ...
    { "name": "치갈기", "nameEn": "Bruxish", "category": "trash", "fast": [], "charged": [], "note": "물/에스퍼" },
    { "name": "타입:널", "nameEn": "Type: Null", "category": "dex", "fast": [], "charged": [], "note": "노말, 희귀" },
    ...
    { "name": "악식킹", "nameEn": "Guzzlord", "category": "dex", "fast": [], "charged": [], "note": "악/드래곤, 울트라비스트" },
    { "name": "텅비드", "nameEn": "Nihilego", "category": "dex", "fast": [], "charged": [], "note": "바위/독, 울트라비스트" },
    { "name": "차곡차곡", "nameEn": "Stakataka", "category": "dex", "fast": [], "charged": [], "note": "바위/강철, 울트라비스트 (GO 등장 미확인)" },
    { "name": "두파팡", "nameEn": "Blacephalon", "category": "dex", "fast": [], "charged": [], "note": "불꽃/고스트, 울트라비스트 (GO 등장 미확인)" },
    { "name": "베베놈", "nameEn": "Poipole", "category": "dex", "fast": [], "charged": [], "note": "독, 울트라비스트 → 아고용 (GO 등장 미확인)" },
    { "name": "아고용", "nameEn": "Naganadel", "category": "dex", "fast": [], "charged": [], "note": "독/드래곤, 울트라비스트 (GO 등장 미확인)" },

    // --- 기타 7세대 ---
    { "name": "자말라", "nameEn": "Komala", "category": "trash", "fast": [], "charged": [], "note": "노말" },
    { "name": "폭거북스", "nameEn": "Turtonator", "category": "trash", "fast": [], "charged": [], "note": "불꽃/드래곤 (GO 등장 미확인)" },
    { "name": "할비롱", "nameEn": "Drampa", "category": "trash", "fast": [], "charged": [], "note": "노말/드래곤 (GO 등장 미확인)" },
    { "name": "타타륜", "nameEn": "Dhelmise", "category": "trash", "fast": [], "charged": [], "note": "고스트/풀 (GO 등장 미확인)" },

    // ===== 8세대 (가라르) Dex / Trash =====
    // --- 스타팅 ---
    { "name": "흥나숭", "nameEn": "Grookey", "category": "dex", "fast": [], "charged": [], "note": "흥나숭이 → 채키몽 → 고릴타" },
    ...
    { "name": "인텔리레온", "nameEn": "Inteleon", "category": "dex", "fast": [], "charged": [], "note": "물" },

    // --- 가라르 일반 ---
    { "name": "탐리스", "nameEn": "Skwovet", "category": "trash", "fast": [], "charged": [], "note": "탈토끼 → 다부니" },
    { "name": "우르", "nameEn": "Wooloo", "category": "trash", "fast": [], "charged": [], "note": "홀비 → 배우르" },
    ...
    { "name": "훔처우", "nameEn": "Nickit", "category": "trash", "fast": [], "charged": [], "note": "훔처우 → 폭슬라이" },
    { "name": "폭슬라이", "nameEn": "Thievul", "category": "trash", "fast": [], "charged": [], "note": "악" },
    { "name": "멍파치", "nameEn": "Yamper", "category": "dex", "fast": [], "charged": [], "note": "모르핀 → 멍파치" },
    { "name": "펄스멍", "nameEn": "Boltund", "category": "dex", "fast": [], "charged": [], "note": "전기" },
    { "name": "탄동", "nameEn": "Rolycoly", "category": "dex", "fast": [], "charged": [], "note": "탄동 → 탄차곤 → 석탄산" },
    { "name": "탄차곤", "nameEn": "Carkol", "category": "dex", "fast": [], "charged": [], "note": "" },
    { "name": "석탄산", "nameEn": "Coalossal", "category": "dex", "fast": [], "charged": [], "note": "바위/불꽃" },
    { "name": "모래뱀", "nameEn": "Silicobra", "category": "dex", "fast": [], "charged": [], "note": "모래뱀 → 사다이사" },
    { "name": "사다이사", "nameEn": "Sandaconda", "category": "dex", "fast": [], "charged": [], "note": "땅" },
    { "name": "찌로꼬치", "nameEn": "Arrokuda", "category": "trash", "fast": [], "charged": [], "note": "찌로꼬치 → 꼬치조" },
    { "name": "꼬치조", "nameEn": "Barraskewda", "category": "trash", "fast": [], "charged": [], "note": "물" },
    { "name": "일레즌", "nameEn": "Toxel", "category": "dex", "fast": [], "charged": [], "note": "사시카마스 → 스트린더" },
    ...
    { "name": "때때무노", "nameEn": "Clobbopus", "category": "dex", "fast": [], "charged": [], "note": "콥꼬치 → 오투스" },
    { "name": "케오퍼스", "nameEn": "Grapploct", "category": "dex", "fast": [], "charged": [], "note": "격투" },
    { "name": "몸지브림", "nameEn": "Hatenna", "category": "dex", "fast": [], "charged": [], "note": "꼬꼬마 → 단데마 → 브리무온" },
    { "name": "손지브림", "nameEn": "Hattrem", "category": "dex", "fast": [], "charged": [], "note": "" },
    { "name": "브리무음", "nameEn": "Hatterene", "category": "dex", "fast": [], "charged": [], "note": "에스퍼/페어리" },
    { "name": "메롱꿍", "nameEn": "Impidimp", "category": "dex", "fast": [], "charged": [], "note": "꼭지모 → 오롱턴 → 오롱특" },
    { "name": "쏘겨모", "nameEn": "Morgrem", "category": "dex", "fast": [], "charged": [], "note": "" },
    { "name": "오롱털", "nameEn": "Grimmsnarl", "category": "dex", "fast": [], "charged": [], "note": "악/페어리" },
    { "name": "대여르", "nameEn": "Falinks", "category": "trash", "fast": [], "charged": [], "note": "격투" },
    { "name": "빙큐보", "nameEn": "Eiscue", "category": "trash", "fast": [], "charged": [], "note": "얼음" },
    { "name": "드라꼰", "nameEn": "Dreepy", "category": "dex", "fast": [], "charged": [], "note": "삼삼드래 → 두래곤 → 드래펄트" },
    { "name": "드래런치", "nameEn": "Drakloak", "category": "dex", "fast": [], "charged": [], "note": "" },
    { "name": "드래펄트", "nameEn": "Dragapult", "category": "dex", "fast": [], "charged": [], "note": "드래곤/고스트, 600족" },
    { "name": "마빌크", "nameEn": "Milcery", "category": "dex", "fast": [], "charged": [], "note": "마호이프 → 마호꿀" },
    { "name": "마휘핑", "nameEn": "Alcremie", "category": "dex", "fast": [], "charged": [], "note": "페어리, 다양한 디자인" },
    { "name": "모르페코", "nameEn": "Morpeko", "category": "trash", "fast": [], "charged": [], "note": "전기/악" },
    { "name": "돌헨진", "nameEn": "Stonjourner", "category": "trash", "fast": [], "charged": [], "note": "바위" },
    { "name": "윽우지", "nameEn": "Cramorant", "category": "trash", "fast": [], "charged": [], "note": "비행/물" },
    { "name": "데인차", "nameEn": "Sinistea", "category": "dex", "fast": [], "charged": [], "note": "두빗 → 포트데스" },
    { "name": "포트데스", "nameEn": "Polteageist", "category": "dex", "fast": [], "charged": [], "note": "고스트" },
    { "name": "두랄루돈", "nameEn": "Duraludon", "category": "dex", "fast": [], "charged": [], "note": "강철/드래곤" },
    ...
    // ===== 9세대 (팔데아) Dex / Trash =====
    // --- 스타팅 ---
    { "name": "나오하", "nameEn": "Sprigatito", "category": "dex", "fast": [], "charged": [], "note": "나비냥 → 나오하 → 마스카나" },
    { "name": "나로테", "nameEn": "Floragato", "category": "dex", "fast": [], "charged": [], "note": "" },
    ...
    // --- 팔데아 일반 ---
    { "name": "맛보돈", "nameEn": "Lechonk", "category": "trash", "fast": [], "charged": [], "note": "하르비 → 해꿀비" },
    { "name": "퍼퓨돈", "nameEn": "Oinkologne", "category": "trash", "fast": [], "charged": [], "note": "노말" },
    { "name": "타랜툴라", "nameEn": "Tarountula", "category": "trash", "fast": [], "charged": [], "note": "구룩 → 시라망구" },
    { "name": "트래피더", "nameEn": "Spidops", "category": "trash", "fast": [], "charged": [], "note": "벌레" },
    { "name": "콩알뚜기", "nameEn": "Nymble", "category": "trash", "fast": [], "charged": [], "note": "노래기냥 → 기르기라스" },
    { "name": "엑스레그", "nameEn": "Lokix", "category": "trash", "fast": [], "charged": [], "note": "벌레/악" },
    { "name": "빠모", "nameEn": "Pawmi", "category": "dex", "fast": [], "charged": [], "note": "콤빠스 → 빠모 → 빠모트" },
    { "name": "빠모트", "nameEn": "Pawmo", "category": "dex", "fast": [], "charged": [], "note": "" },
    { "name": "빠르모트", "nameEn": "Pawmot", "category": "dex", "fast": [], "charged": [], "note": "전기/격투" },
    { "name": "두리쥐", "nameEn": "Tandemaus", "category": "dex", "fast": [], "charged": [], "note": "탱글 → 콩쥐팥쥐" },
    { "name": "파밀리쥐", "nameEn": "Maushold", "category": "dex", "fast": [], "charged": [], "note": "노말, 3마리/4마리 폼" },
    { "name": "쫀도기", "nameEn": "Fidough", "category": "dex", "fast": [], "charged": [], "note": "콩알뚜기 → 쫀도기" },
    { "name": "바우첼", "nameEn": "Dachsbun", "category": "dex", "fast": [], "charged": [], "note": "페어리" },
    { "name": "미니브", "nameEn": "Smoliv", "category": "dex", "fast": [], "charged": [], "note": "올리뇨 → 올리르바 → 올리칭" },
    { "name": "올리뇨", "nameEn": "Dolliv", "category": "dex", "fast": [], "charged": [], "note": "" },
    { "name": "올리르바", "nameEn": "Arboliva", "category": "dex", "fast": [], "charged": [], "note": "풀/노말" },
    { "name": "시비꼬", "nameEn": "Squawkabilly", "category": "trash", "fast": [], "charged": [], "note": "노말/비행, 4가지 색상" },
    { "name": "베베솔트", "nameEn": "Nacli", "category": "dex", "fast": [], "charged": [], "note": "깜눈 → 놀눈 → 바위솔트" },
    { "name": "스태솔트", "nameEn": "Naclstack", "category": "dex", "fast": [], "charged": [], "note": "" },
    { "name": "콜로솔트", "nameEn": "Garganacl", "category": "dex", "fast": [], "charged": [], "note": "바위" },
    { "name": "카르본", "nameEn": "Charcadet", "category": "dex", "fast": [], "charged": [], "note": "코지 → 그윽인 or 칠흑인" },
    ...
    { "name": "육파리", "nameEn": "Toedscruel", "category": "dex", "fast": [], "charged": [], "note": "땅/풀" },
    { "name": "절벼게", "nameEn": "Klawf", "category": "trash", "fast": [], "charged": [], "note": "바위" },
    { "name": "캡싸이", "nameEn": "Capsakid", "category": "dex", "fast": [], "charged": [], "note": "카프사이지 → 스코빌란" },
    { "name": "스코빌런", "nameEn": "Scovillain", "category": "dex", "fast": [], "charged": [], "note": "풀/불꽃" },
    { "name": "구르데", "nameEn": "Rellor", "category": "dex", "fast": [], "charged": [], "note": "리키개구리 → 리키버그" },
    { "name": "베라카스", "nameEn": "Rabsca", "category": "dex", "fast": [], "charged": [], "note": "벌레/에스퍼" },
    { "name": "하느라기", "nameEn": "Flittle", "category": "dex", "fast": [], "charged": [], "note": "짜릿거북 → 날쌩거북" },
    { "name": "클레스퍼트라", "nameEn": "Espathra", "category": "dex", "fast": [], "charged": [], "note": "에스퍼" },
    { "name": "어리짱", "nameEn": "Tinkatink", "category": "dex", "fast": [], "charged": [], "note": "타소가레 → 타소령 → 타소마담" },
    { "name": "벼리짱", "nameEn": "Tinkatuff", "category": "dex", "fast": [], "charged": [], "note": "" },
    { "name": "두드리짱", "nameEn": "Tinkaton", "category": "dex", "fast": [], "charged": [], "note": "페어리/강철" },
    { "name": "바다그다", "nameEn": "Wiglett", "category": "trash", "fast": [], "charged": [], "note": "위거스 → 위거슬리" },
    { "name": "바닥트리오", "nameEn": "Wugtrio", "category": "trash", "fast": [], "charged": [], "note": "물" },
    { "name": "떨구새", "nameEn": "Bombirdier", "category": "trash", "fast": [], "charged": [], "note": "비행/악" },
    { "name": "맨돌핀", "nameEn": "Finizen", "category": "dex", "fast": [], "charged": [], "note": "피니좀 → 피니존" },
    { "name": "돌핀맨", "nameEn": "Palafin", "category": "dex", "fast": [], "charged": [], "note": "물, 히어로 폼" },
    { "name": "부르롱", "nameEn": "Varoom", "category": "dex", "fast": [], "charged": [], "note": "스무오봉 → 레브로봉" },
    { "name": "부르르룸", "nameEn": "Revavroom", "category": "dex", "fast": [], "charged": [], "note": "강철/독" },
    { "name": "모토마", "nameEn": "Cyclizar", "category": "trash", "fast": [], "charged": [], "note": "드래곤/노말" },
    { "name": "초롱순", "nameEn": "Glimmet", "category": "dex", "fast": [], "charged": [], "note": "글라이매스 → 글라이몬" },
    ...
    { "name": "어써러셔", "nameEn": "Dondozo", "category": "trash", "fast": [], "charged": [], "note": "물" },
    { "name": "싸리용", "nameEn": "Tatsugiri", "category": "trash", "fast": [], "charged": [], "note": "드래곤/물 (GO 등장 미확인)" },
    { "name": "드니차", "nameEn": "Frigibax", "category": "dex", "fast": [], "charged": [], "note": "파라독스 → 동장군 → 세비에로" },
    { "name": "드니꽁", "nameEn": "Arctibax", "category": "dex", "fast": [], "charged": [], "note": "" },
    { "name": "드닐레이브", "nameEn": "Baxcalibur", "category": "dex", "fast": [], "charged": [], "note": "드래곤/얼음, 600족" },
    { "name": "모으령", "nameEn": "Gimmighoul", "category": "dex", "fast": [], "charged": [], "note": "기치차바랑 → 걸스카우르 (999개 동전 필요)" },
    { "name": "타부자고", "nameEn": "Gholdengo", "category": "dex", "fast": [], "charged": [], "note": "강철/고스트, 동전 999개 필요" },
    ...
    { "name": "깨물부기", "nameEn": "Chewtle", "category": "dex", "fast": [], "charged": [], "note": "물깨비 → 갈까부기" },
    { "name": "갈가부기", "nameEn": "Drednaw", "category": "dex", "fast": [], "charged": [], "note": "물/바위" },
    { "name": "과사삭벌레", "nameEn": "Applin", "category": "dex", "fast": [], "charged": [], "note": "과사삭벌레 → 애프룡/단지래플 (풀/드래곤)" },
    { "name": "애프룡", "nameEn": "Flapple", "category": "dex", "fast": [], "charged": [], "note": "풀/드래곤" },
    { "name": "단지래플", "nameEn": "Appletun", "category": "dex", "fast": [], "charged": [], "note": "풀/드래곤" },
    { "name": "나이킹", "nameEn": "Perrserker", "category": "dex", "fast": [], "charged": [], "note": "나옹(가라르) → 나이킹 (강철)" },
    { "name": "창파나이트", "nameEn": "Sirfetch'd", "category": "dex", "fast": [], "charged": [], "note": "파오리(가라르) → 파오리꼬 (격투)" },
    { "name": "데스판", "nameEn": "Runerigus", "category": "dex", "fast": [], "charged": [], "note": "데스마스(가라르) → 데스니마스 (땅/고스트)" },
    { "name": "찌르성게", "nameEn": "Pincurchin", "category": "trash", "fast": [], "charged": [], "note": "전기" },
    { "name": "누니머기", "nameEn": "Snom", "category": "dex", "fast": [], "charged": [], "note": "누에발이 → 모스노우 (얼음/벌레)" },
    { "name": "모스노우", "nameEn": "Frosmoth", "category": "dex", "fast": [], "charged": [], "note": "얼음/벌레" },
    { "name": "에써르", "nameEn": "Indeedee", "category": "dex", "fast": [], "charged": [], "note": "에스퍼/노말, 암수 폼 다름" },
    { "name": "끼리동", "nameEn": "Cufant", "category": "dex", "fast": [], "charged": [], "note": "꼬마코끼리 → 대왕코끼리" },
    { "name": "대왕끼리동", "nameEn": "Copperajah", "category": "dex", "fast": [], "charged": [], "note": "강철" },
    ...
    { "name": "버드렉스", "nameEn": "Calyrex", "category": "dex", "fast": [], "charged": [], "note": "전설, 에스퍼/풀 (GO 미출시)" },
    { "name": "신비록", "nameEn": "Wyrdeer", "category": "dex", "fast": [], "charged": [], "note": "노라키 → 쁘사이링 (노말/에스퍼, 히스이 진화)" },
    { "name": "사마자르", "nameEn": "Kleavor", "category": "dex", "fast": [], "charged": [], "note": "스라크 → 망도날 (벌레/바위, 히스이 진화)" },
    { "name": "다투곰", "nameEn": "Ursaluna", "category": "dex", "fast": [], "charged": [], "note": "링곰 → 다투곰 (땅/노말, 히스이 진화)" },
    { "name": "대쓰여너", "nameEn": "Basculegion", "category": "dex", "fast": [], "charged": [], "note": "바스라오(히스이) → 이매치 (물/고스트)" },
    { "name": "포푸니크", "nameEn": "Sneasler", "category": "dex", "fast": [], "charged": [], "note": "포푸니(히스이) → 오냐치 (격투/독, 히스이 진화)" },
    { "name": "장침바루", "nameEn": "Overqwil", "category": "dex", "fast": [], "charged": [], "note": "침바루(히스이) → 핀옹 (악/독, 히스이 진화)" },
    { "name": "러브로스", "nameEn": "Enamorus", "category": "dex", "fast": [], "charged": [], "note": "전설, 페어리/비행" },
    { "name": "꿈트렁", "nameEn": "Orthworm", "category": "dex", "fast": [], "charged": [], "note": "강철, 진화 없음" },
    { "name": "키키링", "nameEn": "Farigiraf", "category": "dex", "fast": [], "charged": [], "note": "키링키 → 리링키 (노말/에스퍼)" },
    { "name": "노고고치", "nameEn": "Dudunsparce", "category": "dex", "fast": [], "charged": [], "note": "노고치 → 노고룡 (노말)" },
    { "name": "대도각참", "nameEn": "Kingambit", "category": "dex", "fast": [], "charged": [], "note": "자망칼 → 절각참 → 대왕단 (악/강철)" },
    { "name": "위대한엄니", "nameEn": "Great Tusk", "category": "dex", "fast": [], "charged": [], "note": "땅/격투, 고대 패러독스 (GO 미출시)" },
    { "name": "우렁찬꼬리", "nameEn": "Scream Tail", "category": "dex", "fast": [], "charged": [], "note": "페어리/에스퍼, 고대 패러독스 (GO 미출시)" },
    { "name": "사나운버섯", "nameEn": "Brute Bonnet", "category": "dex", "fast": [], "charged": [], "note": "풀/악, 고대 패러독스 (GO 미출시)" },
    { "name": "날개치는머리", "nameEn": "Flutter Mane", "category": "dex", "fast": [], "charged": [], "note": "고스트/페어리, 고대 패러독스 (GO 미출시)" },
    { "name": "땅을기는날개", "nameEn": "Slither Wing", "category": "dex", "fast": [], "charged": [], "note": "벌레/격투, 고대 패러독스 (GO 미출시)" },
    { "name": "모래털가죽", "nameEn": "Sandy Shocks", "category": "dex", "fast": [], "charged": [], "note": "전기/땅, 고대 패러독스 (GO 미출시)" },
    { "name": "무쇠바퀴", "nameEn": "Iron Treads", "category": "dex", "fast": [], "charged": [], "note": "땅/강철, 미래 패러독스 (GO 미출시)" },
    { "name": "무쇠보따리", "nameEn": "Iron Bundle", "category": "dex", "fast": [], "charged": [], "note": "얼음/물, 미래 패러독스 (GO 미출시)" },
    ...
    { "name": "무쇠독나방", "nameEn": "Iron Moth", "category": "dex", "fast": [], "charged": [], "note": "불꽃/독, 미래 패러독스 (GO 미출시)" },
    { "name": "무쇠가시", "nameEn": "Iron Thorns", "category": "dex", "fast": [], "charged": [], "note": "바위/전기, 미래 패러독스 (GO 미출시)" },
    { "name": "총지엔", "nameEn": "Wo-Chien", "category": "dex", "fast": [], "charged": [], "note": "악/풀, 전설 (GO 미출시)" },
    ...
    { "name": "위유이", "nameEn": "Chi-Yu", "category": "dex", "fast": [], "charged": [], "note": "악/불꽃, 전설 (GO 미출시)" },
    { "name": "고동치는달", "nameEn": "Roaring Moon", "category": "dex", "fast": [], "charged": [], "note": "드래곤/악, 고대 패러독스 (GO 미출시)" },
    { "name": "무쇠무인", "nameEn": "Iron Valiant", "category": "dex", "fast": [], "charged": [], "note": "페어리/격투, 미래 패러독스 (GO 미출시)" },
    { "name": "굽이치는물결", "nameEn": "Walking Wake", "category": "dex", "fast": [], "charged": [], "note": "물/드래곤, 고대 패러독스 (GO 미출시)" },
    { "name": "무쇠잎새", "nameEn": "Iron Leaves", "category": "dex", "fast": [], "charged": [], "note": "풀/에스퍼, 미래 패러독스 (GO 미출시)" },
    { "name": "과미르", "nameEn": "Dipplin", "category": "dex", "fast": [], "charged": [], "note": "과사삭벌레 → 과미르 (풀/드래곤, GO 미출시)" },
    { "name": "차데스", "nameEn": "Poltchageist", "category": "dex", "fast": [], "charged": [], "note": "차데스 → 그우린차 (풀/고스트, GO 미출시)" },
    { "name": "그우린차", "nameEn": "Sinistcha", "category": "dex", "fast": [], "charged": [], "note": "풀/고스트 (GO 미출시)" },
    { "name": "조타구", "nameEn": "Okidogi", "category": "dex", "fast": [], "charged": [], "note": "독/격투, 전설 (GO 미출시)" },
    { "name": "이야후", "nameEn": "Munkidori", "category": "dex", "fast": [], "charged": [], "note": "독/에스퍼, 전설 (GO 미출시)" },
    { "name": "기로치", "nameEn": "Fezandipiti", "category": "dex", "fast": [], "charged": [], "note": "독/페어리, 전설 (GO 미출시)" },
    { "name": "오거폰", "nameEn": "Ogerpon", "category": "dex", "fast": [], "charged": [], "note": "풀, 전설 (GO 미출시)" },
    { "name": "브리두라스", "nameEn": "Archaludon", "category": "dex", "fast": [], "charged": [], "note": "강철/드래곤, 와리더팩 진화 (GO 미출시)" },
    { "name": "과미드라", "nameEn": "Hydrapple", "category": "dex", "fast": [], "charged": [], "note": "풀/드래곤, 과미르 진화 (GO 미출시)" },
    { "name": "꿰뚫는화염", "nameEn": "Gouging Fire", "category": "dex", "fast": [], "charged": [], "note": "불꽃/드래곤, 고대 패러독스 (GO 미출시)" },
    { "name": "날뛰는우레", "nameEn": "Raging Bolt", "category": "dex", "fast": [], "charged": [], "note": "전기/드래곤, 고대 패러독스 (GO 미출시)" },
    { "name": "무쇠암석", "nameEn": "Iron Boulder", "category": "dex", "fast": [], "charged": [], "note": "바위/에스퍼, 미래 패러독스 (GO 미출시)" },
    { "name": "무쇠감투", "nameEn": "Iron Crown", "category": "dex", "fast": [], "charged": [], "note": "강철/에스퍼, 미래 패러독스 (GO 미출시)" },
